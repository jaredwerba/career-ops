...
const USER_PATHS = [
  ...
  'writing-samples/',
  'config/plugins.yml',
  // ── Fork-local additions — a system update must never overwrite these;
  //    they do not exist upstream. NOTE: no quote characters in comments
  //    inside this array (extractArrayFromSource pairs quotes naively). ──
  'build-web-dashboard.mjs',
  'dashboard-server.mjs',
  'shortlist.mjs',
  'lib/clicks-store.mjs',
  'lib/fit-score.mjs',
  'lib/tech-tags.mjs',
  'seeds/top-companies.mjs',
  'run-daily-scans.sh',
  'morning-scan.sh',
  ...
  'resume-content.example.js',
  'parsers/google-careers.py',
  'plugins.local/',
  'plugins.lock',
